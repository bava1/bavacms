<?php
//Класс для вывода списка статей на главной странице сайта
//Class for displaying a list of articles on the main page of the site
class main extends Action {
	...
	public function get_Content() {
		...
		Новые статьи нашего сайта :</p></div>";
